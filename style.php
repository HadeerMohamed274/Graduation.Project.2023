 ...
 <head>
   ...
   <style>
.tracking-in-expand{-webkit-animation:tracking-in-expand 1s cubic-bezier(.215,.61,.355,1.000) .5s both;animation:tracking-in-expand 1s cubic-bezier(.215,.61,.355,1.000) .5s both}
...
.scale-in-tr{-webkit-animation:scale-in-tr 0.5s  cubic-bezier(.25,.46,.45,.94) both;animation:scale-in-tr 0.5s cubic-bezier(.25,.46,.45,.94) both}
