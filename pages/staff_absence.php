...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Staff Absence Page</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Staff Absence</h6>
        </nav>
    ...
    <!-- Guide -->
    <div class="content">
      <a href="#" class="button">Help Yourself <i class="fa fa-play-circle" aria-hidden="true"></i></a>
      <div class="video-container" style="max-width: 25%; margin:0 auto;">
        <span class="close">&#10006;</span>
        <video width="560" height="310" src="../assets/img/StaffAbsence.mp4" controls></video>
      </div>
    </div>
...
<div class="row">    
              ...
              <form method="post" action="staff_absence.php">
                <table class="table align-items-center mt-3">
                  ...
                  ?>
                      ...
                      <input type="checkbox" name="checkbox[]" value="<?php echo $staf['code']; ?>" >
      ...
      <div><button class="btn btn-info" style="color: white; text-align:center;"> <a href="excel/staffabsencedownload.php">Download As Excel Sheet</a></button></div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Name</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">National ID</th>
                   ...
                   ?>
                    <tr>
                      ...
                      <td class="align-middle text-center">
                       ...
                       ?>
                      <a href="staff_absence.php"><button value="<?php echo $staf['code']; ?>" name="success" type="submit" class="btn btn-dark">Retrieve</button></a> 
