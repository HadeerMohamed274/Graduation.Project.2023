...
if(isset($_POST['lagna_no'])){
    ...
    if(isset($_POST['save'])) {
     ...
     $lagn= $_POST['lagna'];
      ...
      foreach($checkboxes as $checkbox) {
          $query = "UPDATE `p31_students_legan` SET `attendance`=0 WHERE StudentCode =$checkbox AND lagna_no=$lagn ";
    ...
    if(isset($_POST['success'])){
      ...
      $query = "UPDATE p31_students_legan SET attendance=1 WHERE StudentCode=$success";
      mysqli_query($bis, $query);
    }  
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Students Absence Page</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Students Absence</h6>
        </nav>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Student Attendance Table</h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <!-- Search with lagna_no -->
              <center><form action="student_absence.php" method="post">
            ...
            <div > 
              ...
              <form method="post" action="student_absence.php">
                  ...
                  <tbody>
                   ...
                   if($lagna){
                    $coursem= $_POST['course'];
                         ...
                         $getData= "SELECT * FROM  p31_students_legan, acceptedstudentdata WHERE p31_students_legan.attendance=1 AND p31_students_legan.studentcode =acceptedstudentdata.studentcode AND p31_students_legan.lagna_no=$lagna AND `CourseCode`='$coursem'  "   ; 
                         $students=mysqli_query($bis, $getData) or die(mysqli_error($bis));
                        $getData1=mysqli_fetch_array($students);
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="../assets//img/<?php echo $student['image'];?>" class="avatar avatar-sm me-3" alt="user2">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $student['StudentCode']; ?></h6>
                          </div>
                        </div>
                      </td>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $student['EngName']; ?></span>
                      </td> 
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $student['lagna_no']; ?></span>
                        <input type="text" value="<?php echo $student['lagna_no']; ?>" hidden name="lagna">
                      </td> 
                   
                         
                      <td class="align-middle text-center">
                   
                      <input type="checkbox" name="checkbox[]" value="<?php echo $student['StudentCode']; ?>" >                  
                      </td>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                   <center>   <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Name</th>  </center>
                  ...
                  <tbody>
                   <?php
                  $lag="SELECT lagna_no FROM  p31_students_legan WHERE attendance= 0";
                  $lags=mysqli_query($bis, $lag) or die(mysqli_error($bis));

                         $getData= "SELECT * FROM  p31_students_legan, acceptedstudentdata WHERE p31_students_legan.attendance=0 AND p31_students_legan.studentcode =acceptedstudentdata.studentcode AND p31_students_legan.lagna_no=12 "; 
                         $students=mysqli_query($bis, $getData) or die(mysqli_error($bis));
                        $getData1=mysqli_fetch_array($students);
                        foreach($students as $student){
                   ?>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $student['EngName']; ?></h6>
                      ...
                      <td class="align-middle text-center">
                       ...
                       ?>
                      <a href="student_absence.php"><button value="<?php echo $student['StudentCode']; ?>" name="success" type="submit" class="btn btn-success">Retrieve</button></a> 
