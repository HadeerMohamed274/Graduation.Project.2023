  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="content">
      ...
      <div class="video-container" style="max-width: 25%; margin:0 auto;">
        ...
        <video width="560" height="310" src="../assets/img/AddStaff.mp4" controls></video>
      </div>
    </div>
...
<div><button class="btn btn-info" style="color: white; text-align:center; margin-left:35px;"> <a href="excel/addstaffdownload.php">Download As Excel Sheet</a></button></div>
